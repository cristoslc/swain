...
- [SPEC-118](../../../spec/Active/(SPEC-118)-swain-trunk-Auto-Detection-Helper/SPEC-118.md) — swain_trunk() Auto-Detection Helper (in progress)
...
- [SPEC-120](../../../spec/Active/(SPEC-120)-Roadmap-Decision-And-Recommendation-Sections/SPEC-120.md) — ROADMAP.md Decision and Recommendation Sections (in progress)
