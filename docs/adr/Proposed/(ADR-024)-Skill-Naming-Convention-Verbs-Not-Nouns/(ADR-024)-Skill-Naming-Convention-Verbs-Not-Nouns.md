...
ADR-023 fixed this by splitting session into verb-named skills (init, teardown) and distributing features to purpose-built skills (roadmap, do, retro, sync, release). The pattern is clear: verb-named skills stay focused; noun-named skills accumulate.
