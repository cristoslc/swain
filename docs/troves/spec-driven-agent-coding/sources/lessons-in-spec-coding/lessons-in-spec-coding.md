---
source-id: "lessons-in-spec-coding"
title: "Lessons from 500K Lines of Spec-Driven Agent Coding"
type: web
url: "https://github.com/jlevy/speculate/blob/main/about/lessons_in_spec_coding.md"
fetched: 2026-05-18T22:46:07Z
hash: "035a3adf26e3c2abf40519e47b44fe06b9109747379cfd5e1a953e8a73a7c6d2"
---
...
You can also see [these slides](https://github.com/jlevy/speculate/blob/main/about/speculate_slides.html) from a talk I gave about this.*
...
[Convex](https://github.com/get-convex) for the backend.
...
5. However, Claude Code web has some annoying restrictions.
   ...
   **Set up Claude Code Web to use the the `gh` CLI** to create the PR for you!
   ...
   [github-cli-setup.md](https://github.com/jlevy/speculate/blob/main/docs/general/agent-setup/github-cli-setup.md) instructions
   I've given here.

6. Similarly, you need a custom setup to **get Claude Code Web to use beads**. See
   [beads-setup.md](https://github.com/jlevy/speculate/blob/main/docs/general/agent-setup/beads-setup.md).
...
We've been very happy with Convex!
