---
source-id: "garrytan-thin-harness-article"
title: "Thin Harness, Fat Skills — Garry Tan on X"
type: web
url: "https://x.com/garrytan/status/2042925773300908103"
fetched: 2026-04-12T03:50:00Z
hash: "093fe381d3a386d6d685dfa61e6c60e54a95c8d1a860e7c31be8a20611d02eeb"
---
...
**Date:** April 11, 2026
**Engagement:** 90 replies, 321 reposts, 2,571 likes, 7,721 bookmarks, 769,258 views
...
**Enrichment.** A skill called /enrich-founder pulls all sources, runs enrichments, diarizes, and highlights the gap between what founders **say** and what they're **actually building**. The deterministic layer handles SQL lookups, GitHub stats, browser tests, social signal pulls, CrustData queries. A cron runs nightly. Six thousand profiles, always fresh.
...
**Matching.** Three invocations of the same matching skill, three completely different strategies: /match-breakout (1,200 founders, clusters by sector affinity), /match-lunch (600, serendipity matching across sectors), /match-live (nearest-neighbor embedding, 200ms, 1:1 pairs).
