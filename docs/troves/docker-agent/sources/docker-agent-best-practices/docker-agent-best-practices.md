---
source-id: "docker-agent-best-practices"
title: "Best practices | Docker Agent Docs"
type: web
url: "https://docs.docker.com/ai/docker-agent/best-practices/"
fetched: 2026-03-17T00:00:00Z
hash: "30fb6976d7e17122080c6804bdf4f85415a522e625ec14c24bf2f6b6756b06c9"
---

# Best Practices — Docker Agent
...
reviewer:
  instruction: |
    Run validation and save output: `docker buildx bake validate > validation.log 2>&1`
    Read validation.log to check for errors.
    The file can be large - read the first 2000 lines. Errors usually appear at the beginning.
  toolsets:
    - type: filesystem
    - type: shell
```
