...
type: cli-manpage
tool-name: "git"
fetched: 2026-04-07T20:22:14Z
hash: "ce08403c44229e173539eedfa059bc942407d2aa937ce24ea33e998867affdd9"
---
...
SSYYNNOOPPSSIISS
       _g_i_t [-v | --version] [-h | --help] [-C <path>] [-c <name>=<value>]
...
DDEESSCCRRIIPPTTIIOONN
       ...
       viewed at hhttttppss::////ggiitt..ggiitthhuubb..iioo//hhttmmllddooccss//ggiitt..hhttmmll or
...
OOPPTTIIOONNSS
       -v, --version
           ...
           This option is internally converted to ggiitt vveerrssiioonn ... and accepts
           the same options as the ggiitt--vveerrssiioonn(1) command. If ----hheellpp is also
           given, it takes precedence over ----vveerrssiioonn.
       ...
       -C <path>
           ...
           non-absolute --CC _<_p_a_t_h_> is interpreted relative to the preceding --CC
           _<_p_a_t_h_>. If _<_p_a_t_h_> is present but empty, e.g.  --CC "", then the
       ...
       -c <name>=<value>
           ...
           ccoonnffiigg ----ttyyppee==bbooooll will convert to ffaallssee.

       --config-env=<name>=<envvar>
           Like --cc _<_n_a_m_e_>==_<_v_a_l_u_e_>, give configuration variable _<_n_a_m_e_> a value,
           where <envvar> is the name of an environment variable from which to
           retrieve the value. Unlike --cc there is no shortcut for directly
           ...
           the _<_e_n_v_v_a_r_> does not exist in the environment.  _<_e_n_v_v_a_r_> may not
           contain an equals sign to avoid ambiguity with _<_n_a_m_e_> containing
           one.
           ...
           //pprroocc//sseellff//ccmmddlliinnee), but not your environment (e.g.
           //pprroocc//sseellff//eennvviirroonn). That behavior is the default on Linux, but may
           not be on your system.

           Note that this might add security for variables such as
           hhttttpp..eexxttrraaHHeeaaddeerr where the sensitive information is part of the
           value, but not e.g.  uurrll.._<_b_a_s_e_>..iinnsstteeaaddOOff where the sensitive
       ...
       -p, --paginate
           ...
           a terminal. This overrides the ppaaggeerr.._<_c_m_d_> configuration options
       ...
       --git-dir=<path>
           ...
           controlled by setting the GGIITT__DDIIRR environment variable. It can be
           an absolute path or relative path to current working directory.

           Specifying the location of the ".git" directory using this option
           (or GGIITT__DDIIRR environment variable) turns off the repository
           ...
           working tree is, with the ----wwoorrkk--ttrreeee==_<_p_a_t_h_> option (or
           GGIITT__WWOORRKK__TTRREEEE environment variable)

           If you just want to run git as if it was started in _<_p_a_t_h_> then use
           ggiitt --CC _<_p_a_t_h_>.
       ...
       --no-replace-objects
           ...
           equivalent to exporting the GGIITT__NNOO__RREEPPLLAACCEE__OOBBJJEECCTTSS environment
           variable with any value. See ggiitt--rreeppllaaccee(1) for more information.

       --no-lazy-fetch
           Do not fetch missing objects from the promisor remote on demand.
           Useful together with ggiitt ccaatt--ffiillee --ee _<_o_b_j_e_c_t_> to see if the object
           is locally available. This is equivalent to setting the
           GGIITT__NNOO__LLAAZZYY__FFEETTCCHH environment variable to 11.
       ...
       --list-cmds=<group>[,<group>...]
           ...
           directory), others (all other commands in $$PPAATTHH that have git-
       ...
       --attr-source=<tree-ish>
           ...
           ggiittaattttrriibbuutteess(5). This is equivalent to setting the GGIITT__AATTTTRR__SSOOUURRCCEE
...
HHIIGGHH--LLEEVVEELL CCOOMMMMAANNDDSS ((PPOORRCCEELLAAIINN))
   ...
   MMaaiinn ppoorrcceellaaiinn ccoommmmaannddss
       ...
       ggiitt--bbaacckkffiillll(1)
       ...
       ggiitt--rreesseett(1)
           Set HHEEAADD or the index to a known state.
   ...
   AAnncciillllaarryy CCoommmmaannddss
       ...
       ggiitt--ddiiaaggnnoossee(1)
       ...
       ggiitt--vveerrssiioonn(1)
   ...
   RReesseett,, rreessttoorree aanndd rreevveerrtt
       There are three commands with similar names: ggiitt rreesseett, ggiitt rreessttoorree and
       ggiitt rreevveerrtt.

       •   ggiitt--rreevveerrtt(1) is about making a new commit that reverts the changes
           made by other commits.

       •   ggiitt--rreessttoorree(1) is about restoring files in the working tree from
       ...
       •   ggiitt--rreesseett(1) is about updating your branch, moving the tip in order
           to add or remove commits from the branch. This operation changes
           the commit history.

           ggiitt rreesseett can also be used to restore the index, overlapping with
           ggiitt rreessttoorree.
...
LLOOWW--LLEEVVEELL CCOOMMMMAANNDDSS ((PPLLUUMMBBIINNGG))
   ...
   MMaanniippuullaattiioonn ccoommmmaannddss
       ...
       ggiitt--rreeppllaayy(1)
   ...
   IInntteerrrrooggaattiioonn ccoommmmaannddss
       ...
       ggiitt--ddiiffff--ppaaiirrss(1)
       ...
       ggiitt--llaasstt--mmooddiiffiieedd(1)
...
RREEPPOOSSIITTOORRYY,, CCOOMMMMAANNDD AANNDD FFIILLEE IINNTTEERRFFAACCEESS
       This documentation discusses repository and command interfaces which
       users are expected to interact with directly. See ----uusseerr--ffoorrmmaattss in
       ggiitt--hheellpp(1) for more details on the criteria.
...
FFIILLEE FFOORRMMAATTSS,, PPRROOTTOOCCOOLLSS AANNDD OOTTHHEERR DDEEVVEELLOOPPEERR IINNTTEERRFFAACCEESS
       This documentation discusses file formats, over-the-wire protocols and
       other git developer interfaces. See ----ddeevveellooppeerr--iinntteerrffaacceess in ggiitt--
       hheellpp(1).

       ggiittffoorrmmaatt--bbuunnddllee(5)
           The bundle file format.

       ggiittffoorrmmaatt--cchhuunnkk(5)
           Chunk-based file formats.

       ggiittffoorrmmaatt--ccoommmmiitt--ggrraapphh(5)
           Git commit-graph format.

       ggiittffoorrmmaatt--iinnddeexx(5)
           Git index format.

       ggiittffoorrmmaatt--ppaacckk(5)
           Git pack format.

       ggiittffoorrmmaatt--ssiiggnnaattuurree(5)
           Git cryptographic signature formats.

       ggiittpprroottooccooll--ccaappaabbiilliittiieess(5)
           Protocol v0 and v1 capabilities.

       ggiittpprroottooccooll--ccoommmmoonn(5)
           Things common to various protocols.

       ggiittpprroottooccooll--hhttttpp(5)
           Git HTTP-based protocols.

       ggiittpprroottooccooll--ppaacckk(5)
           How packs are transferred over-the-wire.

       ggiittpprroottooccooll--vv22(5)
...
SSYYMMBBOOLLIICC IIDDEENNTTIIFFIIEERRSS
       ...
       <tag>
           a valid tag _n_a_m_e (i.e. a rreeffss//ttaaggss//_<_t_a_g_> reference).

       <head>
           a valid head _n_a_m_e (i.e. a rreeffss//hheeaaddss//_<_h_e_a_d_> reference).
...
EENNVVIIRROONNMMEENNTT VVAARRIIAABBLLEESS
   ...
   SSyysstteemm
       HHOOMMEE
           ...
           $$HHOOMMEEDDRRIIVVEE$$HHOOMMEEPPAATTHH if both $$HHOOMMEEDDRRIIVVEE and $$HHOOMMEEPPAATTHH exist;
           otherwise $$UUSSEERRPPRROOFFIILLEE if $$UUSSEERRPPRROOFFIILLEE exists.
   ...
   TThhee GGiitt RReeppoossiittoorryy
       ...
       GGIITT__IINNDDEEXX__FFIILLEE
           ...
           specified, the default of $$GGIITT__DDIIRR//iinnddeexx is used.
       ...
       GGIITT__AALLTTEERRNNAATTEE__OOBBJJEECCTT__DDIIRREECCTTOORRIIEESS
           ...
           ppaatthh--wwiitthh--"-and-:-in-it and vvaanniillllaa--ppaatthh.
       ...
       GGIITT__DDIISSCCOOVVEERRYY__AACCRROOSSSS__FFIILLEESSYYSSTTEEMM
           ...
           boundaries. Like GGIITT__CCEEIILLIINNGG__DDIIRREECCTTOORRIIEESS, this will not affect an
           explicit repository directory set via GGIITT__DDIIRR or on the command
           line.
       ...
       GGIITT__DDEEFFAAUULLTT__HHAASSHH
           ...
           The default is "sha1". See ----oobbjjeecctt--ffoorrmmaatt in ggiitt--iinniitt(1).

       GGIITT__DDEEFFAAUULLTT__RREEFF__FFOORRMMAATT
           ...
           See ----rreeff--ffoorrmmaatt in ggiitt--iinniitt(1).
   ...
   GGiitt CCoommmmiittss
       GGIITT__AAUUTTHHOORR__NNAAMMEE
           ...
           uusseerr..nnaammee and aauutthhoorr..nnaammee configuration settings.

       GGIITT__AAUUTTHHOORR__EEMMAAIILL
           The email address used in the author identity when creating commit
           or tag objects, or when writing reflogs. Overrides the uusseerr..eemmaaiill
           and aauutthhoorr..eemmaaiill configuration settings.

       GGIITT__AAUUTTHHOORR__DDAATTEE
           The date used for the author identity when creating commit or tag
           objects, or when writing reflogs. See ggiitt--ccoommmmiitt(1) for valid
           formats.
       ...
       GGIITT__CCOOMMMMIITTTTEERR__NNAAMMEE
           ...
           the uusseerr..nnaammee and ccoommmmiitttteerr..nnaammee configuration settings.

       GGIITT__CCOOMMMMIITTTTEERR__EEMMAAIILL
           The email address used in the author identity when creating commit
           or tag objects, or when writing reflogs. Overrides the uusseerr..eemmaaiill
           and ccoommmmiitttteerr..eemmaaiill configuration settings.

       GGIITT__CCOOMMMMIITTTTEERR__DDAATTEE
           The date used for the committer identity when creating commit or
           tag objects, or when writing reflogs. See ggiitt--ccoommmmiitt(1) for valid
           formats.
   ...
   GGiitt DDiiffffss
       ...
       GGIITT__EEXXTTEERRNNAALL__DDIIFFFF
           ...
           modified, GGIITT__EEXXTTEERRNNAALL__DDIIFFFF is called with 7 parameters:
       ...
       GGIITT__EEXXTTEERRNNAALL__DDIIFFFF__TTRRUUSSTT__EEXXIITT__CCOODDEE
           If this Boolean environment variable is set to true then the
           GGIITT__EEXXTTEERRNNAALL__DDIIFFFF command is expected to return exit code 0 if it
           considers the input files to be equal or 1 if it considers them to
           be different, like ddiiffff(11). If it is set to false, which is the
   ...
   ootthheerr
       ...
       GGIITT__SSEEQQUUEENNCCEE__EEDDIITTOORR
           ...
           editing the todo list of an interactive rebase. See also ggiitt--
           rreebbaassee(1) and the sseeqquueennccee..eeddiittoorr option in ggiitt--ccoonnffiigg(1).
       ...
       GGIITT__SSSSHH, GGIITT__SSSSHH__CCOOMMMMAANNDD
           ...
           $$GGIITT__SSSSHH on the other hand must be just the path to a program
           (which can be a wrapper shell script, if additional arguments are
           needed).

           Usually it is easier to configure any desired options through your
           personal .sssshh//ccoonnffiigg file. Please consult your ssh documentation
           for further details.
       ...
       GGIITT__SSSSLL__NNOO__VVEERRIIFFYY
       ...
       GGIITT__AATTTTRR__SSOOUURRCCEE
       ...
       GGIITT__CCOONNFFIIGG__GGLLOOBBAALL, GGIITT__CCOONNFFIIGG__SSYYSSTTEEMM
           ...
           system-level configuration files. If GGIITT__CCOONNFFIIGG__SSYYSSTTEEMM is set, the
           system config file defined at build time (usually //eettcc//ggiittccoonnffiigg)
           will not be read. Likewise, if GGIITT__CCOONNFFIIGG__GGLLOOBBAALL is set, neither
           $$HHOOMMEE//..ggiittccoonnffiigg nor $$XXDDGG__CCOONNFFIIGG__HHOOMMEE//ggiitt//ccoonnffiigg will be read. Can
           be set to //ddeevv//nnuullll to skip reading configuration files of the
           respective level.

       GGIITT__CCOONNFFIIGG__NNOOSSYYSSTTEEMM
           Whether to skip reading settings from the system-wide
           $$(pprreeffiixx)//eettcc//ggiittccoonnffiigg file. This Boolean environment variable can
           be used along with $$HHOOMMEE and $$XXDDGG__CCOONNFFIIGG__HHOOMMEE to create a
           predictable environment for a picky script, or you can set it to
           true to temporarily avoid using a buggy //eettcc//ggiittccoonnffiigg file while
           waiting for someone with sufficient permissions to fix it.

       GGIITT__FFLLUUSSHH
           If this Boolean environment variable is set to true, then commands
           such as _g_i_t _b_l_a_m_e (in incremental mode), _g_i_t _r_e_v_-_l_i_s_t, _g_i_t _l_o_g, _g_i_t
       ...
       GGIITT__TTRRAACCEE__CCUURRLL
           ...
           See GGIITT__TTRRAACCEE for available trace output options.
       ...
       GGIITT__TTRRAACCEE22
           ...
           Output from GGIITT__TTRRAACCEE22 is a simple text-based format for human
           readability.
           ...
           aaff__uunniixx::[_<_s_o_c_k_e_t_-_t_y_p_e_>::]_<_a_b_s_o_l_u_t_e_-_p_a_t_h_n_a_m_e_>, Git will try to open
           the path as a Unix Domain Socket. The socket type can be either
           ssttrreeaamm or ddggrraamm.
       ...
       GGIITT__TTRRAACCEE22__EEVVEENNTT
           ...
           interpretation. See GGIITT__TTRRAACCEE22 for available trace output options
           and TTrraaccee22 ddooccuummeennttaattiioonn[2] for full details.

       GGIITT__TTRRAACCEE22__PPEERRFF
           In addition to the text-based messages available in GGIITT__TTRRAACCEE22,
           this setting writes a column-based format for understanding nesting
           regions. See GGIITT__TTRRAACCEE22 for available trace output options and
       ...
       GGIITT__NNOO__RREEPPLLAACCEE__OOBBJJEECCTTSS
       ...
       GGIITT__LLIITTEERRAALL__PPAATTHHSSPPEECCSS
           ...
           example, running GGIITT__LLIITTEERRAALL__PPAATTHHSSPPEECCSS==11 ggiitt lloogg ---- '*.cc' will
           search for commits that touch the path **..cc, not any paths that the
           glob **..cc matches. You might want this if you are feeding literal
           paths to Git (e.g., paths previously given to you by ggiitt llss--ttrreeee,
           ----rraaww diff output, etc).
       ...
       GGIITT__NNOO__LLAAZZYY__FFEETTCCHH
       ...
       GGIITT__RREEFF__PPAARRAANNOOIIAA
           ...
           operations (e.g., ggiitt--pprruunnee(1)) are better off aborting rather than
           ignoring broken refs (and thus considering the history they point
           to as not worth saving). The default value is 11 (i.e., be paranoid
           about detecting and aborting all operations). You should not
           normally need to set this to 00, but it may be useful when trying to
           salvage data from a corrupted repository.

       GGIITT__CCOOMMMMIITT__GGRRAAPPHH__PPAARRAANNOOIIAA
       ...
       GGIITT__AALLLLOOWW__PPRROOTTOOCCOOLL
           ...
           has pprroottooccooll.._<_n_a_m_e_>..aallllooww set to aallwwaayyss (overriding any existing
           configuration). See the description of pprroottooccooll..aallllooww in ggiitt--
           ccoonnffiigg(1) for more details.
       ...
       GGIITT__PPRROOTTOOCCOOLL__FFRROOMM__UUSSEERR
           ...
           used by fetch/push/clone which are configured to the uusseerr state.
           This is useful to restrict recursive submodule initialization from
           an untrusted repository or for programs which feed
           potentially-untrusted URLS to git commands. See ggiitt--ccoonnffiigg(1) for
           more details.

       GGIITT__PPRROOTTOOCCOOLL
           For internal use only. Used in handshaking the wire protocol.
           Contains a colon _: separated list of keys with optional values
           _<_k_e_y_>_[_=_<_v_a_l_u_e_>_]. Presence of unknown keys and values must be
           ignored.
           ...
           when accessing local repositories (i.e., ffiillee:://// or a filesystem
           path), as well as over the ggiitt:://// protocol. For git-over-http, it
           should work automatically in most configurations, but see the
           discussion in ggiitt--hhttttpp--bbaacckkeenndd(1). For git-over-ssh, the ssh server
           may need to be configured to allow clients to pass this variable
           (e.g., by using AAcccceeppttEEnnvv GGIITT__PPRROOTTOOCCOOLL with OpenSSH).
       ...
       GGIITT__OOPPTTIIOONNAALL__LLOOCCKKSS
           ...
           prevent ggiitt ssttaattuuss from refreshing the index as a side effect. This
       ...
       GGIITT__RREEDDIIRREECCTT__SSTTDDIINN, GGIITT__RREEDDIIRREECCTT__SSTTDDOOUUTT, GGIITT__RREEDDIIRREECCTT__SSTTDDEERRRR
           ...
           corresponding standard handle, and if GGIITT__RREEDDIIRREECCTT__SSTTDDEERRRR is 22>&1,
       ...
       GGIITT__AADDVVIICCEE
           If set to 00, then disable all advice messages. These messages are
           ...
           can disable individual messages using the aaddvviiccee..** config keys.
           ...
           (The ----nnoo--aaddvviiccee global option is also available, but old Git
...
DDIISSCCUUSSSSIIOONN
       ...
       rreeffss//hheeaadd// contain the SHA-1 name of the most recent commit (or "head")
       of a branch under development. SHA-1 names of tags of interest are
       stored under rreeffss//ttaaggss//. A symbolic ref named HHEEAADD contains the name of
...
SSEECCUURRIITTYY
       ...
       copied using ggiitt cclloonnee, it is generally safe to clone remote
       repositories with untrusted content, inspect them with ggiitt lloogg, and so
       on.

       However, it is not safe to run Git commands in a .ggiitt directory (or the
       working tree that surrounds it) when that .ggiitt directory itself comes
       ...
       ssaaffee..ddiirreeccttoorryy in ggiitt--ccoonnffiigg(1). While this can help protect you in a
       ...
       If you have an untrusted .ggiitt directory, you should first clone it with
       ggiitt cclloonnee ----nnoo--llooccaall to obtain a clean copy. Git does restrict the set
       of options and hooks that will be run by uuppllooaadd--ppaacckk, which handles the
       server side of a clone or fetch, but beware that the surface area for
       attack against uuppllooaadd--ppaacckk is large, so this does carry some risk. The
       safest thing is to serve the repository as an unprivileged user (either
       via ggiitt--ddaaeemmoonn(1), ssh, or using other tools to change user ids). See
       the discussion in the SSEECCUURRIITTYY section of ggiitt--uuppllooaadd--ppaacckk(1).
...
AAUUTTHHOORRSS
       ...
       hhttttppss::////ooppeennhhuubb..nneett//pp//ggiitt//ccoonnttrriibbuuttoorrss//ssuummmmaarryy gives you a more
...
RREEPPOORRTTIINNGG BBUUGGSS
       ...
       hhttttppss::////lloorree..kkeerrnneell..oorrgg//ggiitt for previous bug reports and other
       discussions.

       Issues which are security relevant should be disclosed privately to the
       Git Security mailing list <ggiitt--sseeccuurriittyy@@ggoooogglleeggrroouuppss..ccoomm[7]>.
