...
**This isn't model-specific.** The swain project has used: Opus 4.6 ($1,456), Sonnet 4.6 ($115), Haiku 4.5 ($0.40), Qwen3.5 (free, 39M tokens), GLM-5. Opus built the POC. Sonnet built most of the test suite. All went off the rails without tests. All converged with tests.
