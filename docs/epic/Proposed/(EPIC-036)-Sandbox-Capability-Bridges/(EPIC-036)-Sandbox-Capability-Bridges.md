...
|------|-------|-------------|--------|
| SPEC-100 | Host tmux Bridge for Sandboxed Agents | SPEC-056, SPEC-081, SPEC-092 | Proposed |
| SPEC-101 | Docker MCP Gateway Profile Access for Sandboxed Agents | SPEC-092 | Proposed |
