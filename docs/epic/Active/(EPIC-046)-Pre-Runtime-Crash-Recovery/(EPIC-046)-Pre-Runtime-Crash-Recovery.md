...
|------|-------|--------|-------|
| [SPEC-180](../../../spec/Complete/(SPEC-180)-Pre-Runtime-Swain-Script/(SPEC-180)-Pre-Runtime-Swain-Script.md) | Pre-Runtime Swain Script | Active | Phase 1-3: structural checks, session selection, runtime invocation |
