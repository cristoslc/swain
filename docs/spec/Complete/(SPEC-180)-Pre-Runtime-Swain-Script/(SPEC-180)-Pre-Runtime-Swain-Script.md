...
- Offer cleanup with operator confirmation (per [ADR-015](../../../adr/Active/(ADR-015)-Tickets-Are-Ephemeral-Execution-Scaffolding/(ADR-015)-Tickets-Are-Ephemeral-Execution-Scaffolding.md): never auto-discard worktree state)
