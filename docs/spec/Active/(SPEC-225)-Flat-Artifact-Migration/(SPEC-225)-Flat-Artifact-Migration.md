...
- Only spec and epic types are known to produce flat files. Other types are already foldered.
- This spec does not create or modify verification logs — it only ensures the infrastructure for SPEC-226 exists in any project.
