...
Build a materializer that consumes the projection JSON from SPEC-266, reconciles per-parent child symlinks, and writes standardized `_unparented/README.md` files where needed.
